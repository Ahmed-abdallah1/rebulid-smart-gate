...
let buttonresopn =document.querySelector(".responsive-nav .button1")
let buttonresopn2 =document.querySelector(".responsive-nav .button2")
function show(){
    ...
    window.addEventListener("scroll", function(){
     ...
     buttonresopn.addEventListener("click", show);
     buttonresopn2.addEventListener("click", show2);
